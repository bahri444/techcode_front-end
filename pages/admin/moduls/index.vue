              ...
              <td class="text-center px-6 py-4">
                <div class="grid lg:grid-cols-3 md:grid-cols-1 w-44 mx-auto">
                  ...
                  <NuxtLink
                    ...
                    class="py-1 w-11 bg-teal-500 text-white font-semibold rounded-lg shadow-md hover:bg-teal-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 ml-1"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="#f1f5f9"
