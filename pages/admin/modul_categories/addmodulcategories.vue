  ...
  <div>
    <NuxtLayout name="sidebar">
      <div
        ...
        <form @submit.prevent="addEbookCategories">
          <!-- JUDUL FORM -->
          ...
          <div class="relative z-0 w-full mb-5 group">
            <input
              ...
              v-model="e_bookCategories.categories_name"
...
<script>
  ...
  export default {
    ...
    methods: {
      addEbookCategories() {
        axios
          .post(BaseUrl + "/api/addmodulcategories", this.e_bookCategories)
          .then((res) => {
            alert("add data succesfully");
            this.e_bookCategories.categories_name = "";
          });
      },
    },
  };
