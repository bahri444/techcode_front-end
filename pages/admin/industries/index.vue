      ...
      <div class="container">
        ...
        <table class="w-full text-sm text-left text-slate-500">
          <thead
            ...
            <tr>
              <th scope="col" class="px-6 py-4">Industry uuid</th>
              <th scope="col" class="px-6 py-4">Industry name</th>
              <th scope="col" class="px-6 py-4">Social media</th>
          ...
          <tbody>
            <tr
              ...
              <td class="px-6 py-4">{{ rows.industry_name }}</td>
              <td class="text-center px-6 py-4">{{ rows.social_media }}</td>
              <td class="text-center px-6 py-4">
                <div class="grid lg:grid-cols-3 md:grid-cols-1 w-44 mx-auto">
                  ...
                  <!-- BUTTON INFO -->
                  <NuxtLink
                    :to="'/admin/industries/' + rows.industry_uuid"
