<template>
  <NuxtLayout name="sidebar">
    <div
      ...
      <form @submit.prevent="AddIndustries" enctype="multipart/form-data">
        <!-- JUDUL FORM -->
...
<script>
  ...
  export default {
    ...
    methods: {
      handleFileUpload(e) {
        this.industries.industy_logo = e.target.files[0];
      },
      AddIndustries(e) {
        e.preventDefault();
        let objectIsExist = this;
        const config = {
          headers: { "content-type": "multipart/form-data" },
        };
        let data = new FormData();
        data.append("industy_logo", this.industries.industy_logo);
        console.log(this.industries);
        axios
          .post(BaseUrl + "/api/addindustries", data, config, this.industries)
          .then((res) => {
            objectIsExist.success = res.data.success;
