<template>
  <div>
    <NuxtLayout name="sidebar"
      ><div class="container">
        <p class="font-semibold text-center mt-2 mb-5">Akun users</p>
        <NuxtLink
        ...
        <table class="w-full text-sm text-left text-slate-500">
          <thead
            ...
            <tr>
              <th scope="col" class="px-6 py-4">user uuid</th>
              <th scope="col" class="px-6 py-4">nama lengkap</th>
              <th scope="col" class="px-6 py-4">email</th>
              <th scope="col" class="px-6 py-4">email verified at</th>
              ...
              <th scope="col" class="px-6 py-4">jenis anggota</th>
              <th scope="col" class="px-6 py-4">status anggota</th>
              <th scope="col" class="px-6 py-4">angkatan</th>
              <th scope="col" class="px-6 py-4">remember token</th>
            ...
            <tr class="bg-white border-b hover:bg-slate-100 text-center">
              ...
              <td class="text-center px-6 py-4">
                <div class="grid lg:grid-cols-2 md:grid-cols-1 w-44 mx-auto">
                  <!-- BUTTON EDIT -->
                  <NuxtLink
                    :to="'/admin/kelas/update/'"
                    class="py-1 w-12 bg-blue-500 border-slate-700 text-white font-semibold rounded-lg shadow-md hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 mr-1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      data-name="Layer 1"
                      viewBox="0 0 24 24"
                  ...
                  <button
                    type="button"
                    @click="($event) => DeleteClasses($event)"
                    class="py-1 w-12 bg-orange-500 text-white font-semibold rounded-lg shadow-md hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 ml-1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="#f1f5f9"
      ...
      <div class="text-center">
        <!-- user_uuid nama_lengkap email email_verified_at password role
          tanggal_lahir jenis_kelamin alamat foto github jenis_anggota
          status_anggota angkatan remember_token -->
      </div>
    </NuxtLayout>
  </div>
</template>
